...
def get_authenticator_from_environment(service_name: str):
...
def read_from_env_variables(service_name: str) -> dict:
...
def read_from_credential_file(service_name: str, separator: str = '=') -> dict:
...
def read_from_vcap_services(service_name: str) -> dict:
